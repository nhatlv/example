angular.module("locator", []), angular.module("locator").directive("locationLookup", [function () {
    return {
        ...
        link: function (e, o, t, n) {
            ...
            e.clear = function () {
                ...
                r.getDetails({reference: o.reference}, function (t) {
                    e.$apply(function () {
                        var a = {
    ...
    return {
        ...
        link: function (e, o) {
            var t = new google.maps.places.AutocompleteService, n = angular.element(o.find("input")), a = function (e) {
                t.getPlacePredictions({input: e}, r)
            }, r = function (o, t) {
    ...
    var e = {isReady: !1, gpsAvailable: !0}, o = [];
    ...
    return e.ready(function () {
        ...
        var n = o.defer();
        if (e)var a = new google.maps.LatLng(e.latitude, e.longitude); else n.reject("You need to provide LatLng");
        return t.geocoder.geocode({latLng: a}, function (e, o) {
